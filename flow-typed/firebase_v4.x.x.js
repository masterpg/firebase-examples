...
declare class Auth {
  ...
  getRedirectResult(): Promise<FirebaseUserCredential>,
  onAuthStateChanged(
...
declare class FullMetadata extends UploadMetadata {
  bucket: string;
  downloadURLs: string[];
  fullPath: string;
  generation: string;
...
declare class StorageReference {
  bucket: string;
...
declare class SettableMetadata {
  cacheControl?: string;
...
type StringFormat = 'base64' | 'base64url' | 'data_url' | 'raw';

type TaskEvent = 'state_changed';

type TaskState = 'canceled' | 'error' | 'paused' | 'running' | 'success';

declare class UploadMetadata extends SettableMetadata {
  md5Hash?: string;
}
...
declare class UploadTask {
  ...
  on(event: TaskEvent, nextOrObserver?: Observer<any, any> | (a: Object) => any, error?: (a: Error) => any, complete?: () => void): Function;
  pause(): boolean;
  resume(): boolean;
  snapshot: UploadTaskSnapshot;
  then(onFulfilled?: (a: UploadTaskSnapshot) => any, onRejected?: (a: Error) => any): Promise<any>;
}

declare class UploadTaskSnapshot {
...
declare module 'firebase' {
  declare module.exports: {
    ...
    storage: {
      (app?: App): Storage,
      FullMetadata: typeof FullMetadata,
      Reference: typeof StorageReference,
      SettableMetadata: typeof SettableMetadata,
      UploadMetadata: typeof UploadMetadata,
      UploadTask: typeof UploadTask,
      UploadTaskSnapshot: typeof UploadTaskSnapshot,
    }
  }
}
